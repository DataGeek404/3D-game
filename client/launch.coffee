...
init = (controlType, quality, hud, godmode, multiplayer, username) ->
...
s = [
  ['controlType', ['KEYBOARD'], defaultControls, defaultControls, 'Controls: ']
...
$('step-2').onclick = ->
  ...
  init s[0][3], s[1][3], s[2][3], s[3][3], multiplayer, username
$('step-5').onclick = ->
