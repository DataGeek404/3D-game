...
bkcore.hexgl.HexGL = function(opts)
{
	...
	socket.emit('username', {username: opts.username})

	function onKeyVoice(event)
	{
	...
	this.document.addEventListener('keydown', onKeyVoice, { once: true });
	this.document.addEventListener('keydown', onKeyPress);
}
...
bkcore.hexgl.HexGL.prototype.initGameplay = function()
{
	...
	this.gameplay = new bkcore.hexgl.Gameplay({
		...
		opponentControls: this.components.opponentControls,
...
bkcore.hexgl.HexGL.prototype.tweakShipControls = function(c)
{
