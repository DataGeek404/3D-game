 ...
 */
 ...
 bkcore.hexgl.OpponentControls = function(ctx)
 {
     var self = this;
     ...
     socket.on('opponentKeydown', ({keyCode, position, velocity, rotation, quaternion, socket_id}) => {
        if (!this.active) return;
        if (this.socket_id != socket_id) return;
        self.teleport(position, quaternion)
     ...
     function onKeyDown(event)
     {
         ...
         //socket.emit('keydown', {keyCode: event.keyCode, position, rotation, velocity});
     ...
     socket.on('opponentKeyup', ({keyCode, position, velocity, rotation, quaternion, socket_id}) => {
        if (!this.active) return;
        if (this.socket_id != socket_id) return;
     ...
     {
         //socket.emit('keyup', {keyCode: event.keyCode, position, rotation, velocity});
         switch(event.keyCode)
         {
 ...
 bkcore.hexgl.OpponentControls.prototype.control = function(threeMesh)
 {
     this.mesh = threeMesh;
 ...
 bkcore.hexgl.OpponentControls.prototype.reset = function(position, rotation)
 {
 ...
 bkcore.hexgl.OpponentControls.prototype.terminate = function()
 {
     this.destroy();
 ...
 bkcore.hexgl.OpponentControls.prototype.destroy = function()
 {
 ...
 bkcore.hexgl.OpponentControls.prototype.fall = function()
 {
     this.active = false;
     this.collision.front = false;
     this.collision.left = false;
 ...
 bkcore.hexgl.OpponentControls.prototype.update = function(dt)
 {
     if(this.falling)
     {
     ...
     //position.copy(this.dummy.position)
 ...
 bkcore.hexgl.OpponentControls.prototype.teleport = function(pos, quat)
 {
 ...
 bkcore.hexgl.OpponentControls.prototype.boosterCheck = function(dt)
 {
 ...
 bkcore.hexgl.OpponentControls.prototype.collisionCheck = function(dt)
 {
 ...
 bkcore.hexgl.OpponentControls.prototype.heightCheck = function(dt)
 {
 ...
 bkcore.hexgl.OpponentControls.prototype.getRealSpeed = function(scale)
 {
     return Math.round(
 ...
 bkcore.hexgl.OpponentControls.prototype.getRealSpeedRatio = function()
 {
     return Math.min(
         this.maxSpeed,
         this.speed+this.boost
 ...
 bkcore.hexgl.OpponentControls.prototype.getSpeedRatio = function()
 {
     return (this.speed+this.boost)/ this.maxSpeed;
 };
 
 bkcore.hexgl.OpponentControls.prototype.getBoostRatio = function()
 {
     return this.boost / this.boosterSpeed;
 };
 
 bkcore.hexgl.OpponentControls.prototype.getShieldRatio = function()
 {
     return this.shield / this.maxShield;
 };
 
 bkcore.hexgl.OpponentControls.prototype.getShield = function(scale)
 {
     return Math.round(
         this.shield
         * (scale == undefined ? 1 : scale)
 ...
 bkcore.hexgl.OpponentControls.prototype.getPosition = function()
 {
     return this.dummy.position;
 }
 
 bkcore.hexgl.OpponentControls.prototype.getQuaternion = function()
 {
